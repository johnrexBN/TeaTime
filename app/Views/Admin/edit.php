            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div align="right"><a class="btn btn-danger" href="<?= site_url('products') ?>" role="button">Cancel</a></div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div>
                    ...
                    <input type="hidden" name="_method" value="PUT" />
                      ...
                      <input type="text" name="category" value="<?= $products['category']; ?>" class="form-control" placeholder="Enter Product Category">
                      <br>
